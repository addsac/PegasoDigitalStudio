            ...
            <main>
                <div className="relative h-[120vh] flex items-center justify-center">
                    ...
                    <ServiceTitles
                        ...
                        title={[ 'Social Media' ]} 
                        description={[
                            <p className='text-white opacity-100'>Non sai come attirare <b>potenziali clienti</b> sui social? I tuoi contenuti non portano i risultati che vorresti? Non hai mai tempo da dedicare ai tuoi social?</p>,
