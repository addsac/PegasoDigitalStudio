...
export default function ServiceProcess({ cipsText = '', type = '', text = '', description = '', data1 = {}, data2 = {}, data3 = {}, data4 = {}, id = '' }) {
  return (
    <div className="mx-auto max-w-[1600px] w-full grid grid-cols-12 gap-x-6 px-8 md:px-12 lg:px-16 -mt-16">
        ...
        <div className="col-span-12 md:col-span-5">
            <div className="pt-16">
                ...
                <div id={'process-' + id} className="title-4 leading-[120%] bg-gradient-radial-text-left my-10">
        ...
        {/* step of the process */}
        <div className="col-span-12 md:col-span-6 flex flex-col gap-y-4 pt-16">
            {[1, 2, 3, 4].map((value) => (
                <div key={value + '-process-step'}>
                    <div className="p-[1px] bg-gradient-to-r from-slate-700 to-slate-900 rounded-xl" style={{ zIndex: 5 }}>
                        <div className="flex items-center gap-x-16 w-full rounded-[calc(12px-1px)] bg-gradient-to-r from-slate-800 to-slate-900">
                            ...
                            <div className="relative w-full lg:w-full tracking-tight flex flex-col gap-y-6 p-10">
                                <div className="w-10 h-10 flex items-center justify-center cips-bg rounded-full">
                                    ...
                                    {/* icone per servizio branding */}
                                    { type == 'branding' && value == 1 && (
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-white">
                                            <path fillRule="evenodd" d="M3 6a3 3 0 013-3h2.25a3 3 0 013 3v2.25a3 3 0 01-3 3H6a3 3 0 01-3-3V6zm9.75 0a3 3 0 013-3H18a3 3 0 013 3v2.25a3 3 0 01-3 3h-2.25a3 3 0 01-3-3V6zM3 15.75a3 3 0 013-3h2.25a3 3 0 013 3V18a3 3 0 01-3 3H6a3 3 0 01-3-3v-2.25zm9.75 0a3 3 0 013-3H18a3 3 0 013 3V18a3 3 0 01-3 3h-2.25a3 3 0 01-3-3v-2.25z" clipRule="evenodd" />
                                        </svg>
                                    ) }
                                    { type == 'branding' && value == 2 && (
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-white">
                                            <path fillRule="evenodd" d="M9 4.5a.75.75 0 01.721.544l.813 2.846a3.75 3.75 0 002.576 2.576l2.846.813a.75.75 0 010 1.442l-2.846.813a3.75 3.75 0 00-2.576 2.576l-.813 2.846a.75.75 0 01-1.442 0l-.813-2.846a3.75 3.75 0 00-2.576-2.576l-2.846-.813a.75.75 0 010-1.442l2.846-.813A3.75 3.75 0 007.466 7.89l.813-2.846A.75.75 0 019 4.5zM18 1.5a.75.75 0 01.728.568l.258 1.036c.236.94.97 1.674 1.91 1.91l1.036.258a.75.75 0 010 1.456l-1.036.258c-.94.236-1.674.97-1.91 1.91l-.258 1.036a.75.75 0 01-1.456 0l-.258-1.036a2.625 2.625 0 00-1.91-1.91l-1.036-.258a.75.75 0 010-1.456l1.036-.258a2.625 2.625 0 001.91-1.91l.258-1.036A.75.75 0 0118 1.5zM16.5 15a.75.75 0 01.712.513l.394 1.183c.15.447.5.799.948.948l1.183.395a.75.75 0 010 1.422l-1.183.395c-.447.15-.799.5-.948.948l-.395 1.183a.75.75 0 01-1.422 0l-.395-1.183a1.5 1.5 0 00-.948-.948l-1.183-.395a.75.75 0 010-1.422l1.183-.395c.447-.15.799-.5.948-.948l.395-1.183A.75.75 0 0116.5 15z" clipRule="evenodd" />
                                        </svg>
                                    ) }
                                    { type == 'branding' && value == 3 && (
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-white">
                                ...
                                <p className="text-sm md:text-base text-white/60 leading-[160%] pr-8">
                                    { value == 1 && data1.description }
                                    { value == 2 && data2.description }
                                    { value == 3 && data3.description }
                                    { value == 4 && data4.description }
                                </p>
                            </div>
                        </div>
                    </div>
