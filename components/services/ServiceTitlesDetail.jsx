...
export default function ServiceTitlesDetail({ text = [], description = '', cipsText, id = '' }){
    return (
        <>
            ...
            <div className="w-full px-16 grid grid-cols-12 gap-x-6 relative">
                <div className="col-span-3"></div> {/* margin */}
                <div className="col-span-6">
                    ...
                    <div className="text-center">
                        ...
                        <p id={'description-' + id} className="text-3 text-white/60 tracking-tight px-8">
                            { description }
                        </p>
                    </div>
                </div>
