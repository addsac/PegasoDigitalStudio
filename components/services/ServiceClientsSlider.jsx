...
export default function ServiceClientsSlider({ id }) {
    const arrayToLoop = [
        ...
        },
        {
            ...
            href: 'https://www.tiktok.com/@moirabonaldocosmetologa',
            social: 'tiktok'
        },
        {
            name: 'Chiara Moretti',
                        ...
                        arrayToLoop.map((item, index) => (
                            <SwiperSlide style={{ width: 'auto' }} key={index}>
                                <Link target="_blank" href={item.href}>
                                    <div className="group w-[200px] md:w-[200px] h-[300px] md:h-[350px] relative overflow-clip flex flex-col items-center justify-center cursor-pointer rounded-[19px] bg-slate-900">
                                        <Image
                                            src={`/img/services/social-media/${item.photo}`}
                                            alt=""
                                            width={200}
                                            height={350}
                                            className="link-for-mouse-animation text-cursor-trascina w-full h-full object-cover opacity-80 animation duration-200 group-hover:scale-105 bg-slate-900"
                                        />
                                                    ...
                                                    { item.social == 'instagram' ? 
                                                        (
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='h-4 w-4'>
                                                                <path d="M16.65 7.2H16.66M8 20H16C18.2091 20 20 18.2091 20 16V8C20 5.79086 18.2091 4 16 4H8C5.79086 4 4 5.79086 4 8V16C4 18.2091 5.79086 20 8 20ZM15.75 12C15.75 14.0711 14.0711 15.75 12 15.75C9.92893 15.75 8.25 14.0711 8.25 12C8.25 9.92893 9.92893 8.25 12 8.25C14.0711 8.25 15.75 9.92893 15.75 12Z" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                                            </svg>
                                                        ) : item.social == 'tiktok' ?
                                                        (
                                                            <svg fill="#ffffff" width="24" height="24" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" className='h-4 w-4'>
