            ...
            <div className="col-span-12 md:col-span-10 lg:col-span-8">
                <div className="w-full grid grid-cols-8 gap-x-6 gap-y-8">
                    ...
                    <div className="col-span-8 lg:col-span-7">
                        <Text2 
                            text="Our imagery celebrates creators in every role of the storytelling craft, with vivid lighting and production adding the sense of heightened reality."
                            color="white"
                        />
                    </div>
                </div>
