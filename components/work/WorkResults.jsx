        ...
        <div className="grid grid-cols-12 gap-x-6 px-8 md:px-12 lg:px-16">
            ...
            <div className="col-span-12 lg:col-span-8">
                <div className="w-full grid grid-cols-8 gap-x-6">
                    <div className="col-span-4 md:col-span-2 flex lg:justify-center">
                        { (result?.length > 0 && result[0]?.data != '') && (
                            <div className="h-[172px] flex flex-col gap-y-3">
                                <p className="text-4xl font-semibold text-white"> { result[0]?.data } </p>
                    ...
                    <div className="col-span-4 md:col-span-2 flex lg:justify-center">
                        { (result?.length > 0 && result[1]?.data != '') && (
                            <div className="h-[172px] flex flex-col gap-y-3">
                                <p className="text-4xl font-semibold text-white"> { result[1]?.data } </p>
                    ...
                    <div className="col-span-4 md:col-span-2 flex lg:justify-center">
                        { (result?.length > 0 && result[2]?.data != '') && (
                            <div className="h-[172px] flex flex-col gap-y-3">
                                <p className="text-4xl font-semibold text-white"> { result[2]?.data } </p>
                    ...
                    <div className="col-span-4 md:col-span-2 flex lg:justify-center">
                        { (result?.length > 0 && result[3]?.data != '') && (
                            <div className="h-[172px] flex flex-col gap-y-3">
                                <p className="text-4xl font-semibold text-white"> { result[3]?.data } </p>
                ...
                <div className="w-full grid grid-cols-8 gap-x-6">
                    ...
                    <div className="col-span-4 md:col-span-3 flex lg:justify-center">
                        { (result?.length > 0 && result[4]?.data != '') && (
                            <div className="h-auto flex flex-col gap-y-3">
                                <p className="text-4xl font-semibold text-white"> { result[4]?.data } </p>
                    ...
                    <div className="col-span-4 md:col-span-3 flex lg:justify-center">
                        { (result?.length > 0 && result[5]?.data != '') && (
                            <div className="h-auto flex flex-col gap-y-3">
                                <p className="text-4xl font-semibold text-white"> { result[5]?.data } </p>
