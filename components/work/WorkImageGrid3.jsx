    ...
    <div className="mx-auto max-w-6xl w-full grid grid-cols-12 gap-x-6 px-8 md:px-12 lg:px-16">
        ...
        <div className="col-span-12 lg:col-span-5">
            <div className="w-full grid grid-cols-12 gap-y-6">
                <div className="col-span-12 w-full h-auto md:h-[400px] p-4 overflow-clip bg-white flex items-center justify-center">
                    <Image
                ...
                <div className="col-span-12 w-full h-auto md:h-[400px] overflow-clip">
                    <Image
        ...
        {/* right */}
        <div className="col-span-12 lg:col-span-5">
            <div className="w-full h-auto md:h-[824px] p-4 overflow-clip bg-black flex items-center justify-center">
                <video
                    autoPlay={true} 
                    loop={true}
                    muted={true} 
